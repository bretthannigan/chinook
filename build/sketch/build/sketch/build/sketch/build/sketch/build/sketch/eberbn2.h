...
class eberbn2 {
    public:
        eberbn2(uint8_t pin_oGlowRelay, uint8_t pin_oFanRelay, uint8_t pin_oFuelRelay, uint8_t pin_iFlameSwitch, uint8_t iOverheatSwitch);
    ...
    private:
        // Helper functions.
        void _set_port(uint8_t pin, bool val);
        bool _get_port(uint8_t pin);
